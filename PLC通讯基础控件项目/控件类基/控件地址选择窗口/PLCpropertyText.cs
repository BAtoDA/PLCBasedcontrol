...
namespace PLC通讯基础控件项目.控件类基.控件地址选择窗口
{
    ...
    sealed class PLCpropertyText : PLCpublic
    {
        ...
        /// 状态0字体背景颜色参数
        /// </summary>
        public dynamic TextBase { get; set; } 
        /// <summary>
        /// 状态暂时保存
        /// </summary>
        ...
        public PLCpropertyText(UIComboBox Textstate, UIButton Text0, UIButton Text1, UIComboBox FontText, UIComboBox FontSize, UIComboBox Fontalign
            ...
            , dynamic TextBase,UIButton SetplcButton)
        {
            //填充标签状态
            for (int i = 0; i < 2; i++)
        ...
        /// <param name="TextBase"></param>
        public PLCpropertyText(UIComboBox Textstate, UIButton Text0, UIButton Text1, UIComboBox FontText, UIComboBox FontSize, UIComboBox Fontalign
            , UIComboBox Fontflicker, UIRichTextBox TextrichTextBox, UIColorPicker TextColor, UICheckBox TextFont1, UICheckBox TextFont2
            , dynamic TextBase, UIButton SetplcButton)
        {
            //填充标签状态
            for (int i = 0; i < 2; i++)
            ...
            //----------------处理保存文档---------------
            this.TextBase = TextBase;
            TextSwitch(false, FontText, FontSize, Fontalign, Fontflicker, TextrichTextBox, TextColor, TextFont1, TextFont2);
            //----------------处理保存文档事件---------------
            Textstate.TextChanged += ((send, e) => { PLCselectBasee(Textstate, FontText, FontSize, Fontalign, Fontflicker, TextrichTextBox, TextColor,  TextFont1, TextFont2); });
            Text0.Click += ((send, e) => { Textstate.Text = "0"; PLCselectBasee(Textstate, FontText, FontSize, Fontalign, Fontflicker, TextrichTextBox, TextColor, TextFont1, TextFont2); });
            Text1.Click += ((send, e) => { Textstate.Text = "1"; PLCselectBasee(Textstate, FontText, FontSize, Fontalign, Fontflicker, TextrichTextBox, TextColor, TextFont1, TextFont2); });
            SetplcButton.Click += ((send, e) =>
            {
                PLCselectBasee(Textstate, FontText, FontSize, Fontalign, Fontflicker, TextrichTextBox, TextColor, TextFont1, TextFont2);
            });
        }
        /// <summary>
        /// 用户切换时切换以及保存数据
        ...
        /// <param name="TextFont2"></param>
        /// <param name="TextBase"></param>
        private void TextSwitch(bool Base, UIComboBox FontText, UIComboBox FontSize, UIComboBox Fontalign, UIComboBox Fontflicker, UIRichTextBox TextrichTextBox, UIColorPicker TextColor, UICheckBox TextFont1, UICheckBox TextFont2)
        {
            if (!Base)
            {
                //处理0--状态--
        ...
        /// <param name="TextFont2"></param>
        /// <param name="TextBase"></param>
        private void PLCselectBasee(UIComboBox Textstate, UIComboBox FontText, UIComboBox FontSize, UIComboBox Fontalign, UIComboBox Fontflicker, UIRichTextBox TextrichTextBox, UIColorPicker TextColor, UICheckBox TextFont1, UICheckBox TextFont2)
        {
            if (!PLCselectTexte)
            {
                //处理0--状态--
