...
namespace PLC通讯基础控件项目.控件类基.PLC基础接口.PLC基础实现类.PLC报警显示控件实现类
{
    ...
    public class PLCEvent_DataList
    {
        ...
        /// 唯一不可重复
        /// </summary>
        public static  Dictionary<string,List<PLCData>> PLCEvent_Data = new Dictionary<string, List<PLCData>>();
        /// <summary>
        /// 存储PLC批量读取的最大数量
        /// </summary>
        public static  Dictionary<string, List<DataList<int>>> PLCEventCount = new Dictionary<string, List<DataList<int>>>();
        [Serializable]
